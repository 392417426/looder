...
## 17、Browser对象有哪些？
* Window:表示浏览器打开的窗口<br />
Navigator：表示包含有关浏览器的信息 <br />
Screen：包含有关客户端显示屏幕的信息 <br />
History：浏览器历史纪录<br />
Location：包含当前url的信息<br />
window 方法：alert、open、close<br />
history 方法：back、forwards、go<br />
location 方法：assign、replace、reload

## 18、Dom对象有哪些？
* document：每个载入浏览器的html文档都会成为document对象<br />
element：html元素<br />
Attribute：html属性<br />
Event:代表事件的状态
